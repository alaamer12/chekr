...
| Doc | Description |
|-----|-------------|
| [Architecture](internal/ARCHITECTURE.md) | Engine modules and data flow |
| [Requirements](internal/REQUIREMENTS.md) | Feature specification |
| [Decisions](internal/DECISIONS.md) | Design decision log |
| [Roadmap](internal/ROADMAP.md) | Milestones |
| [Future](internal/FUTURE.md) | Long-term vision |
